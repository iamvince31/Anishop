...
const Footer = () => {
  return (
    <footer className="relative mt-12 bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white pt-8 overflow-hidden">
      {/* Top Border Accent */}
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-6">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-bold text-accent uppercase tracking-widest text-xs mb-3">Quick Links</h4>
          ...
          {/* Connect */}
          <div>
            <h4 className="font-display font-bold text-accent uppercase tracking-widest text-xs mb-3">Connect</h4>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent hover:-translate-y-1 transition-all duration-300"
              >
                <img src="/.legacy/image/facebook.jfif" alt="Facebook" className="w-4 h-4 rounded-full" />
              </a>
            </div>
          </div>
        </div>
